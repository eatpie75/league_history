...
(function() {
  var af_app, app, bridge_status_middleware, child_process, client, client_restart, colors, express, http, id, initial, instance, lolclient_middleware, options, path, routes, start_client, status, util, _log;
