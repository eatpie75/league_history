import os
from league_history.settings.default import *
...
if 'TEMPLATE_CONSTANTS' in locals():
	for backend in TEMPLATES:
		if 'constants' in backend['OPTIONS']:
			backend['OPTIONS']['constants'].update(TEMPLATE_CONSTANTS)
