...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for player in orm['lol.player'].objects.filter(items__contains='|3172|'):
            items=player.items.split('|')[1:-1]
            new_items=[]
            for item in items:
                if item=='3172':
                    new_items.append('9001')
                else:
    ...
    models = {
        ...
        'lol.summoner': {
            ...
            'time_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 18, 0, 0)'}),
