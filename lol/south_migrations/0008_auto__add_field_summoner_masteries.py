...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Summoner.masteries'
        db.add_column('lol_summoner', 'masteries',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Summoner.masteries'
        db.delete_column('lol_summoner', 'masteries')
    ...
    models = {
        ...
        'lol.summoner': {
            ...
            'time_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 22, 0, 0)'}),
