...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Summoner.fully_update'
        db.add_column('lol_summoner', 'fully_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Summoner.fully_update'
        db.delete_column('lol_summoner', 'fully_update')
