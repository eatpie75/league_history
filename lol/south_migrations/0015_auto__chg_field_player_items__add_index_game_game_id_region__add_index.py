...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.items'
        db.alter_column(u'lol_player', 'items', self.gf('django.db.models.fields.CharField')(max_length=43))
        # Adding index on 'Game', fields ['game_id', 'region']
        # db.create_index(u'lol_game', ['game_id', 'region'])

        # # Adding index on 'Game', fields ['game_map', 'game_mode']
        # db.create_index(u'lol_game', ['game_map', 'game_mode'])

        # # Adding index on 'SummonerRating', fields ['summoner', 'game_map', 'game_mode']
        # db.create_index(u'lol_summonerrating', ['summoner_id', 'game_map', 'game_mode'])

        # # Adding index on 'Summoner', fields ['region', 'account_id']
        # db.create_index(u'lol_summoner', ['region', 'account_id'])


    def backwards(self, orm):
        # Removing index on 'Summoner', fields ['region', 'account_id']
        # db.delete_index(u'lol_summoner', ['region', 'account_id'])

        # # Removing index on 'SummonerRating', fields ['summoner', 'game_map', 'game_mode']
        # db.delete_index(u'lol_summonerrating', ['summoner_id', 'game_map', 'game_mode'])

        # # Removing index on 'Game', fields ['game_map', 'game_mode']
        # db.delete_index(u'lol_game', ['game_map', 'game_mode'])

        # # Removing index on 'Game', fields ['game_id', 'region']
        # db.delete_index(u'lol_game', ['game_id', 'region'])


        # Changing field 'Player.items'
        db.alter_column(u'lol_player', 'items', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    models = {
        ...
        u'lol.summoner': {
            ...
            'time_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 0, 0)'}),
