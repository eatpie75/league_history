...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.won'
        db.add_column('lol_player', 'won',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Summoner.time_updated'
        db.alter_column('lol_summoner', 'time_updated', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Player.won'
        db.delete_column('lol_player', 'won')


        # Changing field 'Summoner.time_updated'
        db.alter_column('lol_summoner', 'time_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'lol.summoner': {
            ...
            'time_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)'}),
