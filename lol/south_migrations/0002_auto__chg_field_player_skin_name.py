...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.skin_name'
        db.alter_column('lol_player', 'skin_name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Player.skin_name'
        db.alter_column('lol_player', 'skin_name', self.gf('django.db.models.fields.CharField')(default='', max_length=64))
