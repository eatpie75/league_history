...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.sight_wards_bought_in_game'
        db.add_column('lol_player', 'sight_wards_bought_in_game',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.sight_wards_bought_in_game'
        db.delete_column('lol_player', 'sight_wards_bought_in_game')
