...
(function() {
  ...
  TellMeMore = (function() {
    ...
    TellMeMore.prototype.info_template = function(args) {
      return "<td colspan=11>			<div class='span4'>				<b>Physical/Magical Damage</b><br>				<div class='hori-bar centered'>					<div class='red' title='Physical Damage' style='width:" + ((args.physical_damage_dealt / args.damage_dealt) * 100) + "%;'></div>					<div class='blue' title='Magical Damage' style='width:" + (100 - (args.physical_damage_dealt / args.damage_dealt) * 100) + "%;'></div>				</div>			</div>		</td>";
    };
