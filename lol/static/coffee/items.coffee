...
items=
	...
	1001:
		name:"Boots of Speed"
		description:"UNIQUE Passive: Enhanced Movement 1 (does not stack with other Boots)."
	1004:
		name:"Faerie Charm"
	...
	1006:
		...
		description:"+8 Health Regen per 5 seconds"
	1007:
		name:"Regrowth Pendant"
		description:"+15 Health Regen per 5 seconds"
	1011:
		name:"Giant's Belt"
		description:"+430 Health"
	1018:
		name:"Cloak of Agility"
		description:"+18% Critical Strike Chance"
	1026:
		name:"Blasting Wand"
	...
	1054:
		name:"Doran's Shield"
		description:"+120 Health<br>+10 Armor<br>+8 Health Regen per 5 seconds"
	1055:
		name:"Doran's Blade"
		description:"+80 Health<br>+10 Attack Damage<br>+3% Life Steal"
	1056:
		name:"Doran's Ring"
		description:"+80 Health<br>+15 Ability Power<br>+5 Mana Regen per 5 seconds"
	1057:
		name:"Negatron Cloak"
	...
	1062:
		...
		description:"+20 Attack Damage<br>+5% Life Steal<br>UNIQUE Passive: +200 Health (does not stack with other Prospector items)."
	1063:
		name:"Prospector's Ring"
		description:"+30 Ability Power<br>+7 Mana Regen per 5 seconds<br>UNIQUE Passive: +200 Health (does not stack with other Prospector items)."
	2003:
		name:"Health Potion"
	...
	3001:
		...
		description:"+70 Ability Power<br>+57 Magic Resist<br>UNIQUE Aura: Reduces the Magic Resist of nearby enemy champions by 20."
	3003:
	...
	3006:
		...
		description:" +25% Attack Speed<br>UNIQUE Passive: Enhanced Movement 2 (does not stack with other Boots)."
	3009:
		name:"Boots of Swiftness"
		description:"UNIQUE Passive: Enhanced Movement 3 (does not stack with other Boots)"
	3010:
		name:"Catalyst the Protector"
		description:"+290 Health<br>+325 Mana<br>UNIQUE Passive: On leveling up, restores 250 Health and 200 Mana over 8 seconds."
	3020:
		name:"Sorcerer's Shoes"
		description:"+20 Magic Penetration<br>UNIQUE Passive: Enhanced Movement 2 (does not stack with other Boots)."
	3022:
		name:"Frozen Mallet"
		description:"+700 Health<br>+20 Attack Damage<br>UNIQUE Passive: Your basic attacks slow your target's Movement Speed by 40% for 2.5 seconds (30% for ranged attacks)."
	3024:
		name:"Glacial Shroud"
		description:"+425 Mana<br>+45 Armor<br>UNIQUE Passive: +15% Cooldown Reduction."
	3026:
		name:"Guardian Angel"
		description:"+68 Armor<br>+38 Magic Resist<br>UNIQUE Passive: Revives your champion upon death, restoring 750 Health and 375 Mana (5 minute cooldown)."
	3027:
		name:"Rod of Ages"
		description:"+450 Health<br>+525 Mana<br>+60 Ability Power<br>Passive: Your champion gains 18 Health, 20 Mana, and 2 Ability Power every minute (up to 10 times).<br>UNIQUE Passive: On leveling up, restores 250 Health and 200 Mana over 8 seconds."
	3028:
		name:"Chalice of Harmony"
		description:"+30 Magic Resist<br>+7.5 Mana Regen per 5 seconds<br>UNIQUE Passive: Increases your Mana Regen by 1% per 1% Mana you are missing."
	3031:
		name:"Infinity Edge"
		description:"+80 Attack Damage<br>+25% Critical Strike Chance<br>UNIQUE Passive: Your critical strikes now deal 250% damage instead of 200%."
	3035:
		name:"Last Whisper"
		description:"+40 Attack Damage<br>UNIQUE Passive: +40% Armor Penetration."
	3037:
		name:"Mana Manipulator"
		description:"UNIQUE Aura: Nearby allied champions gain 7.2 Mana Regen per 5 seconds."
	3041:
	...
	3057:
		name:"Sheen"
		description:"+250 Mana<br>+25 Ability Power<br>UNIQUE Passive: After using an ability, your next basic attack deals bonus physical damage equal to your base Attack Damage (2 second cooldown). Does not stack with Trinity Force or Lich Bane."
	3065:
		name:"Spirit Visage"
		description:"+30 Magic Resist<br>+250 Health<br>UNIQUE Passive: +10% Cooldown Reduction.<br>UNIQUE Passive: Increases your healing and regeneration effects on yourself by 15%."
	3067:
		name:"Kindlegem"
	...
	3069:
		...
		description:"+330 Health<br>+30 Health Regen per 5 seconds<br>+15 Mana Regen per 5 seconds<br>UNIQUE Passive: +15% Cooldown Reduction.<br>UNIQUE Active: Nearby allied champions gain 40% Movement Speed for 3 seconds (60 second cooldown)."
	3070:
		name:"Tear of the Goddess"
		description:"+350 Mana<br>+7 Mana Regen per 5 seconds<br>UNIQUE Passive: Each time you use an ability, your maximum Mana increases by 4 (3 second cooldown). Bonus caps at +1000 Mana. Does not stack with Archangel's Staff or Manamune."
	3071:
		name:"The Black Cleaver"
		description:"+55 Attack Damage<br>+30% Attack Speed<br>UNIQUE Passive: Your basic attacks reduce your target's Armor by 15 for 5 seconds (effect stacks up to 3 times)."
	3072:
		name:"The Bloodthirster"
		description:"+60 Attack Damage<br>+12% Life Steal<br>Passive: Gains 1 stack per kill, up to a maximum of 40. Each stack grants +1 Attack Damage and +0.2% Life Steal (max: +40 Attack Damage and +8% Life Steal). Half of the current stacks are lost upon death."
	3075:
		name:"Thornmail"
		description:"+100 Armor<br>UNIQUE Passive: On being hit by basic attacks, returns 30% of damage taken as magic damage."
	3077:
		name:"Tiamat"
		description:"+50 Attack Damage<br>+15 Health Regen per 5 seconds<br>+5 Mana Regen per 5 seconds<br>Passive: Your basic attacks splash, dealing 50% area damage around the target (35% for ranged attacks)."
	3078:
		name:"Trinity Force"
	...
	3082:
		name:"Warden's Mail"
		description:"+50 Armor<br>+20 Health Regen per 5 seconds<br>UNIQUE Passive: 20% chance on being hit by basic attacks to slow the attacker's Movement and Attack Speeds by 35% for 3 seconds."
	3083:
		name:"Warmog's Armor"
	...
	3098:
		...
		description:"+25 Ability Power<br>UNIQUE Passive: Gain an additional 5 Gold every 10 seconds."
	3099:
		name:"Soul Shroud"
		description:"+520 Health<br>UNIQUE Aura: Nearby allied champions gain 10% Cooldown Reduction and 12 Mana Regen per 5 seconds."
	3100:
		name:"Lich Bane"
		description:"+350 Mana<br>+80 Ability Power<br>+30 Magic Resist<br>+7% Movement Speed<br>UNIQUE Passive: After using an ability, your next basic attack gains bonus physical damage equal to your Ability Power (2 second cooldown). Does not stack with Sheen or Trinity Force."
	3101:
		name:"Stinger"
	...
	3115:
		name:"Nashor's Tooth"
		description:"+50% Attack Speed<br>+65 Ability Power<br>+10 Mana Regen per 5 seconds<br>UNIQUE Passive: +25% Cooldown Reduction."
	3116:
	...
	3124:
		...
		description:"+35 Attack Damage<br>+45 Ability Power<br>UNIQUE Passive: On basic attack or ability use, increases your Attack Speed by 4% and Ability Power by 6 for 5 seconds (effect stacks up to 8 times)."
	3126:
		name:"Madred's Bloodrazor"
		description:"+40 Attack Damage<br>+40% Attack Speed<br>+25 Armor<br>UNIQUE Passive: Your basic attacks deal bonus magic damage equal to 4% of the target's maximum Health."
	3128:
	...
	3136:
		name:"Haunting Guise"
		description:"+25 Ability Power<br>+200 Health<br>UNIQUE Passive: +20 Magic Penetration."
	3138:
		name:"Leviathan"
	...
	3144:
		...
		description:"+35 Attack Damage<br>+15% Life Steal<br>UNIQUE Active: Deals 150 magic damage and slows the target champion's Movement Speed by 50% for 3 seconds (60 second cooldown)."
	3145:
		name:"Hextech Revolver"
		description:"+40 Ability Power<br>UNIQUE Passive: +12% Spell Vamp."
	3146:
		name:"Hextech Gunblade"
		description:"+40 Attack Damage<br>+70 Ability Power<br>+15% Life Steal<br>UNIQUE Passive: +20% Spell Vamp.<br>UNIQUE Active: Deals 300 magic damage and slows the target champion's Movement Speed by 50% for 3 seconds (60 second cooldown)."
	3152:
	...
	3155:
		name:"Hexdrinker"
		description:"+25 Attack Damage<br>+30 Magic Resist<br>UNIQUE Passive: If you would take magic damage that would leave you at less than 30% Health, you first gain a shield that absorbs 250 magic damage for 5 seconds (60 second cooldown)."
	3156:
		name:"Maw of Malmortius"
		description:"+55 Attack Damage<br>+36 Magic Resist<br>UNIQUE Passive: If you would take magic damage that would leave you at less than 30% Health, you first gain a shield that absorbs 400 magic damage for 5 seconds (60 second cooldown).<br>UNIQUE Passive: +1 Attack Damage for every 2.5% of your Maximum Health that is missing."
	3157:
		name:"Zhonya's Hourglass"
		description:"+100 Ability Power<br>+50 Armor<br>UNIQUE Active: Places your champion into Stasis for 2 seconds, rendering you invulnerable and untargetable but unable to take any action (90 second cooldown)."
	3158:
	...
	3183:
		...
		description:"+25 health regeneration<br>UNIQUE Passive : +15% Capture Rate (Does not stack with other Capture Rate modifiers).<br>UNIQUE Active: +30% movement speed for 2 seconds. 60 second cooldown."
	3184:
		name:"Entropy"
