...
items=
	...
	3010:
		...
		description:"+200 Health<br>+300 Mana<br>UNIQUE Passive: Valor's Reward: Upon leveling up, restores 150 Health and 200 Mana over 8 seconds."
	3020:
		name:"Sorcerer's Shoes"
		description:"+15 Magic Penetration<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed"
	3022:
		name:"Frozen Mallet"
		description:"+700 Health<br>+30 Attack Damage<br>UNIQUE Passive: Icy: Basic attacks slow the target's Movement Speed for 1.5 seconds on hit (40% slow for melee attacks, 30% slow for ranged attacks)."
	3023:
		name:"Twin Shadows"
		description:"+40 Ability Power<br>+40 Magic Resistance<br>+6% Movement Speed<br>UNIQUE Active: Hunt: Summons up to 2 invulnerable ghosts that seek out the two nearest enemy champions for 6 seconds. If a ghost reaches its target, it reveals the target and reduces their Movement Speed by 40% for 2.5 seconds (120 second cooldown)."
	3024:
		name:"Glacial Shroud"
		description:"+300 Mana<br>+45 Armor<br>UNIQUE Passive: +10% Cooldown Reduction."
	3025:
		name:"Iceborn Gauntlet"
		description:"+30 Ability Power<br>+500 Mana<br>+70 Armor<br>+10% Cooldown Reduction<br>UNIQUE Passive: Spellblade: After using an ability, the next basic attack (on hit) deals bonus physical damage equal to 125% of base Attack Damage to enemies near the target, and creates a field around the target for 2 seconds that slows enemy Movement Speed by 30% (2 second cooldown,  half-sized field if ranged)."
	3026:
		name:"Guardian Angel"
	...
	3027:
		name:"Rod of Ages"
		description:"+450 Health<br>+450 Mana<br>+60 Ability Power<br>Passive: Grants +20 Health, +20 Mana, and +2 Ability Power per stack (max +200 Health, +200 Mana, and +20 Ability Power). Grants 1 stack per minute (max 10 stacks).<br>UNIQUE Passive - Valor's Reward: Upon leveling up, restores 150 Health and 200 Mana over 8 seconds."
	3028:
	...
	3037:
		...
		description:"UNIQUE Aura: Mana Warp: Grants nearby allied champions +6 Mana Regen per 5 seconds."
	3040:
	...
	3041:
		...
		description:"+20 Ability Power<br>UNIQUE Passive: Grants +8 Ability Power per stack. Grants 2 stacks for a kill or 1 stack for an assist (max 20 stacks). A third of the stacks are lost upon death. At 20 stacks, grants +15% Cooldown Reduction."
	3042:
		name:"Muramana"
	...
	3044:
		name:"Phage"
		description:"+200 Health<br>+20 Attack Damage<br>UNIQUE Passive: Icy: Basic attacks have a 25% chance to slow the target's Movement Speed for 2 seconds on hit (30% slow for melee attacks, 20% slow for ranged attacks)."
	3046:
		name:"Phantom Dancer"
		description:"+50% Attack Speed<br>+30% Critical Strike Chance<br>+5% Movement Speed<br>UNIQUE Passive: Champion can move through units."
	3047:
		name:"Ninja Tabi"
	...
	3057:
		name:"Sheen"
		description:"+200 Mana<br>+25 Ability Power<br>UNIQUE Passive: Spellblade: After using an ability, the next basic attack deals bonus physical damage equal to base Attack Damage on hit (2 second cooldown)."
	3060:
		name:"Banner of Command"
		description:"+40 Ability Power<br>+30 Armor<br>+10% Cooldown Reduction<br>UNIQUE Aura: Valor: Grants nearby allies +10 Health Regen per 5 seconds. Nearby allied minions deal 15% increased damage.<br>UNIQUE Active: Promote: Transforms a nearby siege minion into a more powerful unit and grants all gold that the unit earns (180 second cooldown)."
	3065:
		name:"Spirit Visage"
	...
	3075:
		name:"Thornmail"
		description:"+100 Armor<br>UNIQUE Passive: Upon being hit by a basic attack, returns 30% of the incoming damage (before being reduced by defenses) to the attacker as magic damage."
	3077:
		name:"Tiamat"
	...
	3100:
		name:"Lich Bane"
		description:"+80 Ability Power<br>+250 Mana<br>+5% Movement Speed<br>UNIQUE Passive: Spellblade: After using an ability, the next basic attack deals 50 (+75% of Ability Power) bonus magic damage on hit (2 second cooldown)."
	3101:
		name:"Stinger"
	...
	3122:
		name:"Wicked Hatchet"
		description:"+20 Attack Damage<br>+18% Critical Strike Chance<br>UNIQUE Passive: Basic attacks inflict Grievous Wounds on enemy champions for 1.5 seconds on hit."
	3123:
	...
	3132:
		name:"Heart of Gold"
		description:"+325 Health<br>UNIQUE Passive: +5 Gold per 10 seconds."
	3134:
		name:"The Brutalizer"
		description:"+25 Attack Damage<br>UNIQUE Passive: +10% Cooldown Reduction.<br>UNIQUE Passive: +10 Armor Penetration."
	3135:
		name:"Void Staff"
		description:"+70 Ability Power<br>UNIQUE Passive: Magic damage ignores 35% of the target's Magic Resist."
	3136:
		name:"Haunting Guise"
	...
	3172:
		name:"Zephyr"
		description:"+25 Attack Damage<br>+50% Attack Speed<br>+10% Movement Speed<br>+10% Cooldown Reduction<br>UNIQUE Passive: Tenacity: Reduces the duration of stuns, slows, taunts, fears, silences, blinds, and immobilizes by 35%."
	3173:
	...
	3176:
		name:"Arcane Helix"
		description:"+400 Health<br>+300 Mana<br>+10% Cooldown Reduction<br>UNIQUE Passive: Spending Mana heals for 30% of the Mana spent."
	3178:
		name:"Ionic Spark"
		description:"+40% Attack Speed<br>+250 Health<br>UNIQUE Passive: Every fourth basic attack unleashes a chain lightning on hit, dealing 125 magic damage to up to 4 targets."
	3180:
		name:"Odyn's Veil"
	...
	3191:
		...
		description:"+30 Armor<br>+20 Ability Power<br>UNIQUE Passive: Killing a unit grants 0.5 bonus Armor and Ability Power. This bonus stacks up to 30 times."
	3196:
		name:"Augment: Power"
	...
	3198:
		name:"Augment: Death"
		description:"+3 Ability Power per level<br>+45 Ability Power<br>Ability Augment: Death Ray sets fire to enemies, dealing 30% additional magic damage over 4 seconds."
	3200:
		name:"The Hex Core"
	...
	3256:
		...
		description:"+15 Magic Penetration<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Captain: Grants +8% Movement Speed to nearby approaching allied champions. Grants nearby minions +20% Movement Speed."
	3257:
		name:"Sorcerer's Shoes - Furor"
		description:"+15 Magic Penetration<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Furor: Upon dealing damage with a single target spell or attack (on hit), grants +12% Movement Speed that decays over 2 seconds."
	3258:
		name:"Sorcerer's Shoes - Distortion"
		description:"+15 Magic Penetration<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Distortion: Teleport, Flash, and Ghost summoner spell cooldowns are reduced by 25%."
	3259:
	...
	3260:
		...
		description:"+25 Armor<br>UNIQUE Passive: Blocks 10% of the damage from champion basic attacks.<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Homeguard: After being out of combat for 8 seconds, visiting the shop grants full Health, Mana, and +200% Movement Speed that decays over 8 seconds (bonus Movement Speed ends upon entering combat)."
	3261:
		name:"Ninja Tabi - Captain"
		description:"+25 Armor<br>UNIQUE Passive: Blocks 10% of the damage from champion basic attacks.<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Captain: Grants +8% Movement Speed to nearby approaching allied champions. Grants nearby minions +20% Movement Speed."
	3262:
		name:"Ninja Tabi - Furor"
		description:"+25 Armor<br>UNIQUE Passive: Blocks 10% of the damage from champion basic attacks.<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Furor: Upon dealing damage with a single target spell or attack (on hit), grants +12% Movement Speed that decays over 2 seconds."
	3263:
		name:"Ninja Tabi - Distortion"
		description:"+25 Armor<br>UNIQUE Passive: Blocks 10% of the damage from champion basic attacks.<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Distortion: Teleport, Flash, and Ghost summoner spell cooldowns are reduced by 25%."
	3264:
	...
	3265:
		...
		description:"+25 Magic Resist<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Tenacity: The duration of stuns, slows, taunts, fears, silences, blinds and immobilizes are reduced by 35%.<br>UNIQUE Passive: Homeguard: After being out of combat for 8 seconds, visiting the shop grants full Health, Mana, and +200% Movement Speed that decays over 8 seconds (bonus Movement Speed ends upon entering combat)."
	3266:
		name:"Mercury's Treads - Captain"
		description:"+25 Magic Resist<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Tenacity: The duration of stuns, slows, taunts, fears, silences, blinds and immobilizes are reduced by 35%.<br>UNIQUE Passive: Captain: Grants +8% Movement Speed to nearby approaching allied champions. Grants nearby minions +20% Movement Speed."
	3267:
		name:"Mercury's Treads - Furor"
		description:"+25 Magic Resist<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Tenacity: The duration of stuns, slows, taunts, fears, silences, blinds and immobilizes are reduced by 35%.<br>UNIQUE Passive: Furor: Upon dealing damage with a single target spell or attack (on hit), grants +12% Movement Speed that decays over 2 seconds."
	3268:
		name:"Mercury's Treads - Distortion"
		description:"+25 Magic Resist<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Tenacity: The duration of stuns, slows, taunts, fears, silences, blinds and immobilizes are reduced by 35%.<br>UNIQUE Passive: Distortion: Teleport, Flash, and Ghost summoner spell cooldowns are reduced by 25%."
	3269:
	...
	3270:
		...
		description:"UNIQUE Passive: Enhanced Movement: +45 Movement Speed. Increases to +105 Movement Speed when out of combat for 5 seconds.<br>UNIQUE Passive: Homeguard: After being out of combat for 8 seconds, visiting the shop grants full Health, Mana, and +200% Movement Speed that decays over 8 seconds (bonus Movement Speed ends upon entering combat)."
	3271:
		name:"Boots of Mobility - Captain"
		description:"UNIQUE Passive: Enhanced Movement: +45 Movement Speed. Increases to +105 Movement Speed when out of combat for 5 seconds.<br>UNIQUE Passive: Captain: Grants +8% Movement Speed to nearby approaching allied champions. Grants nearby minions +20% Movement Speed."
	3272:
		name:"Boots of Mobility - Furor"
		description:"UNIQUE Passive: Enhanced Movement: +45 Movement Speed. Increases to +105 Movement Speed when out of combat for 5 seconds.<br>UNIQUE Passive: Furor: Upon dealing damage with a single target spell or attack (on hit), grants +12% Movement Speed that decays over 2 seconds."
	3273:
		name:"Boots of Mobility - Distortion"
		description:"UNIQUE Passive: Enhanced Movement: +45 Movement Speed. Increases to +105 Movement Speed when out of combat for 5 seconds.<br>UNIQUE Passive: Distortion: Teleport, Flash, and Ghost summoner spell cooldowns are reduced by 25%."
	3274:
	...
	3275:
		...
		description:"UNIQUE Passive: +15% Cooldown Reduction.<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Homeguard: After being out of combat for 8 seconds, visiting the shop grants full Health, Mana, and +200% Movement Speed that decays over 8 seconds (bonus Movement Speed ends upon entering combat)."
	3276:
		name:"Ionian Boots of Lucidity - Captain"
		description:"UNIQUE Passive: +15% Cooldown Reduction.<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Captain: Grants +8% Movement Speed to nearby approaching allied champions. Grants nearby minions +20% Movement Speed."
	3277:
		name:"Ionian Boots of Lucidity - Furor"
		description:"UNIQUE Passive: +15% Cooldown Reduction.<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Furor: Upon dealing damage with a single target spell or attack (on hit), grants +12% Movement Speed that decays over 2 seconds."
	3278:
		name:"Ionian Boots of Lucidity - Distortion"
		description:"UNIQUE Passive: +15% Cooldown Reduction.<br>UNIQUE Passive: Enhanced Movement: +45 Movement Speed<br>UNIQUE Passive: Distortion: Teleport, Flash, and Ghost summoner spell cooldowns are reduced by 25%."
	3279:
	...
	3280:
		...
		description:"UNIQUE Passive: Enhanced Movement: +60 Movement Speed<br>UNIQUE Passive: Slow Resist: Movement slowing effects are reduced by 25%.<br>UNIQUE Passive: Homeguard: After being out of combat for 8 seconds, visiting the shop grants full Health, Mana, and +200% Movement Speed that decays over 8 seconds (bonus Movement Speed ends upon entering combat)."
	3281:
		name:"Boots of Swiftness - Captain"
		description:"UNIQUE Passive: Enhanced Movement: +60 Movement Speed<br>UNIQUE Passive: Slow Resist: Movement slowing effects are reduced by 25%.<br>UNIQUE Passive: Captain: Grants +8% Movement Speed to nearby approaching allied champions. Grants nearby minions +20% Movement Speed."
	3282:
		name:"Boots of Swiftness - Furor"
		description:"UNIQUE Passive: Enhanced Movement: +60 Movement Speed<br>UNIQUE Passive: Slow Resist: Movement slowing effects are reduced by 25%.<br>UNIQUE Passive: Furor: Upon dealing damage with a single target spell or attack (on hit), grants +12% Movement Speed that decays over 2 seconds."
	3283:
		name:"Boots of Swiftness - Distortion"
		description:"UNIQUE Passive: Enhanced Movement: +60 Movement Speed<br>UNIQUE Passive: Slow Resist: Movement slowing effects are reduced by 25%.<br>UNIQUE Passive: Distortion: Teleport, Flash, and Ghost summoner spell cooldowns are reduced by 25%."
	3284:
