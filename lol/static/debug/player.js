...
(function() {
  ...
  ChampionSort = (function() {
    ...
    ChampionSort.prototype.sort = function(column, spec_order) {
      var _base, _sort, pregex;
      if (spec_order == null) {
        spec_order = null;
      }
      pregex = new RegExp('(\\d+)%', 'i');
      _base = (function(_this) {
        return function(value_1, value_2, total_1, total_2) {
          if (value_1 > value_2) {
      ...
      _sort = (function(_this) {
        return function(a, b) {
          var lower_min, minimum, ref, ref1, ref2, ref3, total_1, total_2, value_1, value_2;
          ref = [$(a), $(b)], a = ref[0], b = ref[1];
          value_1 = a.children("." + column).text();
          value_2 = b.children("." + column).text();
          if ((spec_order != null) && spec_order === 'swin') {
            ref1 = [Number(value_1.match(pregex)[1]), Number(value_2.match(pregex)[1])], value_1 = ref1[0], value_2 = ref1[1];
            ...
            ref2 = [Number(value_1), Number(value_2)], value_1 = ref2[0], value_2 = ref2[1];
            if (value_1 > value_2) {
              return -1 * _this.direction;
            } else if (value_1 === value_2) {
              return 0;
            ...
            ref3 = [Number(value_1.match(pregex)[1]), Number(value_2.match(pregex)[1])], value_1 = ref3[0], value_2 = ref3[1];
            if (value_1 > value_2) {
              return -1 * _this.direction;
            } else if (value_1 === value_2) {
              return 0;
  ...
  querystring = function(oqs) {
    var i, len, obj, option, qs;
    oqs = oqs.split('&');
    qs = {};
    for (i = 0, len = oqs.length; i < len; i++) {
      option = oqs[i];
      obj = option.split('=');
