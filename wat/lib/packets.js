...
(function() {
  var ASObject, AggregatedStatsPacket, AuthPacket, ConnectPacket, Decoder, Encoder, GetMasteryBookPacket, GetSpectatorInfoPacket, GetSummonerDataPacket, GetSummonerNamePacket, GetTeamById, GetTeamForSummoner, HeartbeatPacket, LoginPacket, LookupPacket, Packet, PlayerStatsPacket, RecentGames, uuid,
  ...
  HeartbeatPacket = (function(_super) {
    ...
    HeartbeatPacket.prototype.generate = function(counter) {
      var object;
      object = new ASObject();
      object.name = 'flex.messaging.messages.RemotingMessage';
      object.keys = ['operation', 'source', 'timestamp', 'clientId', 'timeToLive', 'messageId', 'destination', 'headers', 'body'];
      object.object = {
        ...
        destination: 'loginService',
        headers: this.generateHeaders(),
        body: [this.options.acctId, this.options.authToken, counter, new Date().toString().slice(0, -6)]
      };
      object.encoding = 0;
      return object;
    };
  ...
  RecentGames = (function(_super) {
    ...
    function RecentGames() {
      return RecentGames.__super__.constructor.apply(this, arguments);
    }
  ...
  GetTeamForSummoner = (function(_super) {
    ...
    function GetTeamForSummoner() {
      return GetTeamForSummoner.__super__.constructor.apply(this, arguments);
    }
  ...
  GetTeamById = (function(_super) {
    ...
    function GetTeamById() {
      return GetTeamById.__super__.constructor.apply(this, arguments);
    }
