...
(function() {
  var RequestHandler, buffer, child_process, client, client_restart, colors, ev, events, fs, h, http, initial, json, json2, nopt, options, qs, start_client, total_requests, url, util, views, zlib, _log,
